...
const tbs_module_1 = require("../language-server/tbs-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const node_1 = require("langium/node");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, tbs_module_1.createTbsServices)(node_1.NodeFileSystem).Tbs;
...
function default_1() {
    ...
    const fileExtensions = module_1.TbsLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
